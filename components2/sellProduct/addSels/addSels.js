       ...
       if (id&& id!=='add'){
           axios.put(`https://human1moment.herokuapp.com/api/realproduct/${id}/`, postName, {
               ...
               if (response.data.status === "success"){
                   ...
                   alert("Malumot yangilashda hatolik iltimos tekshirib qaytadan harakat qilib ko'ring")
               }
           }).catch((err)=>{
           ...
           alert("Malumotlar qoshishda hatolik iltimos tekshirib qaytadan harak qilib ko'ring")
               }
           }).catch((error)=>{
                    ...
                    <Content className="site-layout-background" style={{ margin: '24px 16px 0', overflow: 'initial' }}>
                        <div className="all-rigth-menu">
                            <div className="for-right-menu">
                                <div>
                                    <Link className="d-flex for-menu-rigth" to="/sellProduct">
