...
function AddexproductO(props) {

    // useEffect(()=>{
    //     axios.get("https://human1moment.herokuapp.com/api/exchangeproduct/").then((response)=>{
    //         console.log(response.data);
    //         setGetSel(response.data)
    //     })
    // }, []);
    ...
    const [push, setPush]= useState({size:"", price:"", by_user:"", count:"", product:"",active:"taken", total:0});
