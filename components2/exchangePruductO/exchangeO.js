...
function ExchangeO(props) {
    ...
    function getex() {
        setLoading(true)
        axios.get('https://human1moment.herokuapp.com/api/exchangeproduct/?active=taken').then((response)=>{
    ...
    return (
        <>
            ...
            <Layout hasSider>
                ...
                <Layout className="site-layout" style={{ marginLeft: 200,  height: '93vh'}}>
                    <Content className="site-layout-background" style={{ margin: '24px 16px 0', overflow: 'initial' }}>
                        ...
                        <div className="all-rigth-menu">
                            ...
                            <Link to="/exchangeProduct/addexchangeO">
